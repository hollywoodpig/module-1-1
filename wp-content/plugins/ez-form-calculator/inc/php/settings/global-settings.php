...
function ezfc_get_global_settings() {
	$settings = array(
		__("Customization", "ezfc") => array(
			...
			"scroll_steps_offset" => array("description" => __("Scroll offset", "ezfc"), "description_long" => __("Top offset when scrolling (in px)", "ezfc"), "type" => Ezfc_settings::$type_input, "default" => -200),
		...
		__("Email", "ezfc") => array(
			"email_price_format_dec_num" => array("description" => __("Price format decimals", "ezfc"), "description_long" => __("Number of decimals in email prices", "ezfc"), "type" => Ezfc_settings::$type_input, "default" => 2, "premium" => true),
			"email_font_family" => array("description" => __("Email font family", "ezfc"), "description_long" => __("Font to be used in email body. It is recommended to provide fallback fonts, example: Arial, Helvetica, sans-serif", "ezfc"), "type" => Ezfc_settings::$type_input, "default" => "Arial, Helvetica, sans-serif", "premium" => true),
			"email_plain_html" => array("description" => __("Use plain HTML", "ezfc"), "description_long" => __("If disabled, HTML elements will be shown as code in emails.", "ezfc"), "type" => Ezfc_settings::$type_yesno, "default" => 1, "premium" => true),
		...
		"WooCommerce" => array(
			"woocommerce"            => array("description" => __("Integrate with WooCommerce", "ezfc"), "description_long" => __("Integrate with WooCommerce. Please be aware that on a single product page, the product price and add-to-cart button will be hidden since the plugin handles this.", "ezfc"), "premium" => true, "type" => Ezfc_settings::$type_yesno),
			"woocommerce_text"       => array("description" => __("'Added to cart' text", "ezfc"), "description_long" => __("This text will be displayed after a submission was added to the cart.", "ezfc"), "premium" => true, "type" => Ezfc_settings::$type_input, "default" => __("Added to cart", "ezfc")),
			"woocommerce_add_forms"  => array("description" => __("Add forms to products", "ezfc"), "description_long" => __("When this option is enabled, forms will be added to products automatically. If you want to show individual forms for products, please make sure you add a custom field to the product:<br>
				...
				More information here: <a href='http://ez-form-calculator.ezplugins.de/documentation/woocommerce-integration/' target='_blank'>ezfc Woocommerce Integration</a>", "ezfc"), "premium" => true, "type" => Ezfc_settings::$type_yesno),
			"woocommerce_global_form_id"  => array("description" => __("Global form ID", "ezfc"), "description_long" => __("Form with this ID will be added to the WooCommerce product when 'Add forms to products' is set to 'Yes'", "ezfc"), "premium" => true, "type" => Ezfc_settings::$type_input),
			"woocommerce_checkout_details" => array("description" => __("Show selected values in checkout", "ezfc"), "description_long" => __("Show the selected values in a table on the checkout page", "ezfc"), "premium" => true, "type" => Ezfc_settings::$type_yesno, "default" => 1),
			"woocommerce_checkout_details_text" => array("description" => __("Checkout details text", "ezfc"), "description_long" => __("If 'Show selected values in checkout' is enabled, display this text above the details table.", "ezfc"), "premium" => true, "type" => Ezfc_settings::$type_input, "default" => "Selected values"),
			"woocommerce_checkout_details_values" => array("description" => __("Checkout details values", "ezfc"), "description_long" => __("Details text in checkout: 'Full Details' shows all values and calculations. 'Simple details' shows values and prices. 'Values only' shows the selected values only. <strong>Note: only applies to products added after this values was changed.</strong>", "ezfc"), "premium" => true, "type" => Ezfc_settings::$type_dropdown, "default" => "result", "options" => array(
			...
			"woocommerce_enable_edit" => array("description" => __("Editable cart items", "ezfc"), "description_long" => __("Customers can edit the submitted form in the cart. When set to 'Yes', an editable link will be added to relevant cart items.", "ezfc"), "premium" => true, "type" => Ezfc_settings::$type_yesno, "default" => 1),
			"woocommerce_edit_text" => array("description" => __("Edit text", "ezfc"), "description_long" => __("Text of the edit link.", "ezfc"), "premium" => true, "type" => Ezfc_settings::$type_input, "default" => __("Edit", "ezfc")),
			"woocommerce_add_hook"  => array("description" => __("Form display hook", "ezfc"), "description_long" => sprintf(__("WooCommerce hook when forms are added to products (for a full list, see %s", "ezfc"), "<a href='https://docs.woocommerce.com/wc-apidocs/hook-docs.html' target='_blank'>docs.woothemes.com</a>)"), "premium" => true, "type" => Ezfc_settings::$type_input, "default" => "woocommerce_after_single_product"),
			"woocommerce_product_id" => array("description" => __("WooCommerce product id", "ezfc"), "description_long" => __("<strong>NOTE:</strong> this value is deprecated since v2.7.3 and has no effect - set the WooCommerce product id in the form options", "ezfc"), "premium" => true, "type" => Ezfc_settings::$type_input),
			"woocommerce_update_cart" => array("description" => __("Update cart", "ezfc"), "description_long" => __("Update the mini-cart after adding products. Please note that you use the correct CSS selector or the cart will not be updated.", "ezfc"), "premium" => true, "type" => Ezfc_settings::$type_yesno, "default" => 0),
			"woocommerce_update_cart_selector" => array("description" => __("Cart CSS selector", "ezfc"), "description_long" => __("The mini-cart CSS selector can change depending on your theme. If you are not sure, you might want to contact the theme author.", "ezfc"), "premium" => true, "type" => Ezfc_settings::$type_input, "default" => ".cart_list"),
			"woocommerce_insert_db" => array("description" => __("Insert form submissions on checkout", "ezfc"), "description_long" => __("Insert form submissions for each product that was added from the form on checkout.", "ezfc"), "premium" => true, "type" => Ezfc_settings::$type_yesno, "default" => 0),
		...
		__("Other", "ezfc") => array(
			...
			"user_roles"             => array("description" => __("User roles", "ezfc"), "description_long" => __("Check which user role has access to edit this plugin.", "ezfc"), "type" => "roles", "default" => "administrator", "premium" => true),
			...
			"css_form_label_width" => array("description" => __("CSS label width", "ezfc"), "description_long" => __("Width of the labels. Default: 15em", "ezfc") . " - <strong>" . __("Deprecated", "ezfc") . "</strong>", "type" => Ezfc_settings::$type_input)
		)
	);
