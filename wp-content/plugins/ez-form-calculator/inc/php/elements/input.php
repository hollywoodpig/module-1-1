...
class Ezfc_Element_Input extends Ezfc_Element {
	public function get_output() {
		...
		$el_text .= "<input	class='{$this->data->class} ezfc-element ezfc-element-input' {$this->output["factor"]} id='{$this->output["element_child_id"]}' name='{$this->output["element_name"]}' placeholder='{$this->data->placeholder}' type='{$input_type}' value='{$this->data->value}' {$add_attr} {$this->output["style"]} {$this->output["required"]} />";
